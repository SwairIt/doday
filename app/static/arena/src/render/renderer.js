...
// Ниже 0.8 картинка заметно мылится — дальше режем не разрешение,
// а эффекты (см. автоснижение качества в src/main.js).
const RESOLUTION_MIN = 0.8;
const RESOLUTION_STEP_DOWN = 0.1;
const RESOLUTION_STEP_UP = 0.05;

/** Пороги FPS для адаптации. */
// Понижать разрешение при 55 FPS нельзя: на 60-герцовом мониторе кадр
// постоянно колеблется около 55-59, разрешение уезжало вниз и не
// возвращалось — картинка навсегда становилась мыльной.
const FPS_LOW = 40;
const FPS_HIGH = 50;
