...
ENDPOINTS: list[Endpoint] = [
    ...
    Endpoint("/blog", 200, "blog"),
    Endpoint("/blog/kak-bystro-sdelat-domashnee-zadanie", 200, "blog-post"),
    Endpoint("/blog/sitemap.xml", 200, "blog-sitemap"),
    ...
    Endpoint("/doday/app/today", 401, "auth-gate-today"),
    Endpoint("/doday/app/inbox", 401, "auth-gate-inbox"),
    Endpoint("/doday/app/calendar", 401, "auth-gate-calendar"),
    Endpoint("/doday/app/team", 401, "auth-gate-team"),
    Endpoint("/doday/app/profile", 303, "profile-redirects-settings"),
